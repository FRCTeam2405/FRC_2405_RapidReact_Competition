...
public class ClimberStageThreeRelease extends CommandBase {

  private final DoritoClimber sysClimber;
  private final LEDLights sysLedLights;

  /** Creates a new ClimberStageThreeRelease. */
  public ClimberStageThreeRelease(DoritoClimber inSysClimber, LEDLights inSysLedLights)  {
  ...
  public boolean isFinished() {
    if (sysClimber.getClimberThree() == true)
      return true;
    else return false;
  }
}
